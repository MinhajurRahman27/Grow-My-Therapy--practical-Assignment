...
const IntroductionSection = () => {
  return (
    <div className=" flex flex-col-reverse md:flex-row items-center h-[130vh]   bg-secondary  py-[10vh] overflow-hidden ">
      ...
      <div className=" flex items-center   justify-center md:justify-start  relative md:pt-[4vh] ">
        <Image
          ...
          className="rounded-t-[1000px]  w-[180px] md:h-[78vh]   lg:h-[90vh]  md:w-[300px] lg:w-[350px]"
        ></Image>
